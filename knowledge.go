...
// UploadDocument uploads a document to the knowledge base via multipart form.
func (k *KnowledgeResource) UploadDocument(ctx context.Context, projectID string, opts UploadDocumentOptions) (*KBDocument, error) {
	var result KBDocument
